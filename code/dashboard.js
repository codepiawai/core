...
<div class="row shadow">
<div id="progres" class="col-1-2 card">  ${d.view.progress(arr)} </div>
<div id="pie" class="col-1-2 card">  ${d.view.pie(arr)} </div>
</div>
</div>
...
controller:{
  ...
  hi:function(i){ d.modal('hi')
},

    view:function(i){
  data=d.getls('data');
  if(data) { dashboard.controller.dashboard(i);  }
