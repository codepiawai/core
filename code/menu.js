...
{id:6,induk:1,nama:"Dashboards",isi:1,icon:"house",url:"loadAndRun('app/master/dashboards.js?dashboards.controller.view()')"},
{id:7,induk:1,nama:"Menu",isi:2,icon:"menu",url:"loadAndRun('app/master/menu.js?menus.controller.view()')"},
{id:8,induk:1,nama:"Users",isi:3,icon:"person",url:"loadAndRun('app/master/users.js?users.controller.view()')"},
{id:9,induk:1,nama:"Akses",isi:4,icon:"lock",url:"loadAndRun('app/master/akses.js?akses.controller.view()')"},
{id:10,induk:1,nama:"Setting",isi:5,icon:"setting",url:"loadAndRun('app/master/setting.js?setting.controller.view()')"},
{id:11,induk:1,nama:"Param",isi:6,icon:"setting",url:"loadAndRun('app/master/param.js?params.controller.view()')"},
{id:12,induk:1,nama:"Pesan",isi:7,icon:"envelope",url:"loadAndRun('app/master/pesan.js?pesan.controller.view()')"},
...
view:function(i){
    data=d.getls('data');
    if(data) { menu.controller.menu(i);  }
